...
// Comment : this version seats on top of blast_try5_BC_v7 but is has a corrected version
// 	     of the imposition of the periodicity of the interpolation data
//           meaning that the main modification is by the end of the reader function
