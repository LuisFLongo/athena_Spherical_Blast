...
#pragma omp simd simdlen(SIMD_WIDTH)
      for (int i=il; i<=iu; ++i) {
        ...
        Real u1 = prim(IVX,k,j,i) + 1e-16;
        Real u2 = prim(IVY,k,j,i) + 1e-16;
        Real u3 = prim(IVZ,k,j,i) + 1e-16;
...
//	printf("cons(IDN,k,j,i) = %6.40lf \n", cons(IDN,k,j,i));
//        normal_ee_(i) = cons(IEN,k,j,i);
//        printf("cons(IEN,k,j,i) = %6.40lf \n", cons(IEN,k,j,i));
//        normal_mm_(0,i) =
//            SQR(cons(IM1,k,j,i)) + SQR(cons(IM2,k,j,i)) + SQR(cons(IM3,k,j,i));
//        normal_mm_(1,i) = cons(IM1,k,j,i);
//	printf("cons(IM1,k,j,i) = %6.40lf \n", cons(IM1,k,j,i));
//        normal_mm_(2,i) = cons(IM2,k,j,i);
//	printf("cons(IM2,k,j,i) = %6.40lf \n", cons(IM2,k,j,i));
//        normal_mm_(3,i) = cons(IM3,k,j,i);
//	printf("cons(IM3,k,j,i) = %6.40lf \n", cons(IM3,k,j,i));
//
//        printf("prim(IDN,k,j,i) = %6.40lf \n", prim(IDN,k,j,i));
//        printf("prim(IPR,k,j,i) = %6.40lf \n", prim(IPR,k,j,i));
//        printf("prim(IVX,k,j,i) = %6.40lf \n", prim(IVX,k,j,i));
//        printf("prim(IVY,k,j,i) = %6.40lf \n", prim(IVY,k,j,i));
//        printf("prim(IVZ,k,j,i) = %6.40lf \n", prim(IVZ,k,j,i));
//
//      }
	...
	if(i <=3 ){
		...
		printf("INSIDE x1 ghost zone \n");
		printf("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n");
	}else{
		printf("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
		printf("OUSIDE x1 ghost zone \n");
		printf("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
	}
