...
void EquationOfState::ConservedToPrimitive(
  ...
  for (int k=kl; k<=ku; ++k) {
    for (int j=jl; j<=ju; ++j) {
      ...
      for (int i=il; i<=iu; ++i) {
	//printf("Test 1 \n");
	//if (i <=4 or j<=4 or k <=4 or i >=iu-4 or j>=ju-4 or k>=ku-4){
	//	printf("Inside the ghostzone \n");
	//}else{
	//	printf("Outside the ghostzone \n");
	//}
	//printf("Test 2 \n");
	  ...
	  printf("IF N1 \n");
        ...
        bool success = ConservedToPrimitiveNormal(normal_dd_, normal_ee_, normal_mm_,
                                                  ...
                                                  &gamma);
        if (success){
		printf("success1 = true");
	}else {
		printf("success1 = false");
	}
        ...
        if (success && (rho_add > 0.0 || pgas_add > 0.0)) {
          ...
          success = ConservedToPrimitiveNormal(normal_dd_, normal_ee_, normal_mm_,
                                               ...
                                               &gamma);
          if (success){
                  printf("success2 = true");
          }else {
                  printf("success2 = false");
          }
...
bool ConservedToPrimitiveNormal(
    ...
    const AthenaArray<Real> &mm_vals, Real gamma_adi, Real pgas_old, int k, int j, int i,
    AthenaArray<Real> &prim, Real *p_gamma_lor) {
    printf("Entering ConservedToPrimitiveNormal \n");
  // Parameters
